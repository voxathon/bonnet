...
CLIENT_COMMANDS = {
    ...
    "publish_board_close": "PUBLISH_RECORD",
    "publish_board_reopen": "PUBLISH_RECORD",
    "publish_board_purge": "PUBLISH_RECORD",
    "publish_user_register": "PUBLISH_RECORD",
    "publish_user_revoke": "PUBLISH_RECORD",
    "publish_user_key_rotate": "PUBLISH_RECORD",
    ...
    "publish_thread_close": "PUBLISH_RECORD",
    "publish_thread_reopen": "PUBLISH_RECORD",
...
CLIENT_KINDS = {
    ...
    "publish_board_close": "bonnet.board.close",
    "publish_board_reopen": "bonnet.board.reopen",
    "publish_board_purge": "bonnet.board.purge",
    "publish_thread_close": "bonnet.thread.close",
    "publish_thread_reopen": "bonnet.thread.reopen",
    ...
    "publish_user_register": "bonnet.user.register",
    "publish_user_revoke": "bonnet.user.revoke",
    "publish_user_key_rotate": "bonnet.user.key.rotate",
