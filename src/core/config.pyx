...
cdef class Matcher:
    ...
    @staticmethod
    def from_dict(dict data) -> 'Matcher':
        if 'pubkey' in data:
...
cdef class ACLEntry:
    ...
    cdef public Matcher matcher
    cdef public list board_patterns
    cdef public bint read_perm
    cdef public bint write_perm
    
    def __init__(self, str name, Matcher matcher, list board_patterns, bint read_perm, bint write_perm):
        self.name = name
    ...
    def board_matches(self, str board_name) -> bool:
    ...
    @staticmethod
    def from_dict(str name, dict data) -> 'ACLEntry':
...
cdef class Config:
    ...
    cdef public str userfile_path
    cdef public int port_standard
    cdef public int port_privileged
    cdef public int max_connections
    cdef public int max_request_size
    cdef public int rate_limit_requests
    cdef public int rate_limit_window
    ...
    cdef void _resolve_paths(self, str identity_path, str userfile_path, str nav_db_path, str reports_db_path, str punishments_db_path, str log_dir):
        """
    ...
    cdef str _resolve_path(self, str explicit_path, str default_name):
        """
