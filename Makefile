...
MODULES := module1 module2 module3 __init
...
$(BIN_DIR)/main: $(BUILD_DIR)/main.c $(BUILD_DIR)/module1.so $(BUILD_DIR)/module2.so $(BUILD_DIR)/module3.so $(BUILD_DIR)/__init.so | $(BIN_DIR)
